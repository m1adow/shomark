...
public class PostService : IPostService
{
    ...
    private readonly IFragmentProjectionRepository _fragmentProjectionRepository;

    public PostService(
        IPostRepository postRepository,
        IPlatformRepository platformRepository,
        IFragmentProjectionRepository fragmentProjectionRepository)
    {
        _postRepository = postRepository;
        _platformRepository = platformRepository;
        _fragmentProjectionRepository = fragmentProjectionRepository;
    }
    ...
    public async Task<Result<PostDto>> CreateAsync(CreatePostRequest request, CancellationToken ct = default)
    {
        ...
        var post = new Post
        {
            ...
            FragmentStorageKey = fragment.StorageKey,
            FragmentThumbnailKey = fragment.ThumbnailKey,
            Title = request.Title,
