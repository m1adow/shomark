...
public class PostConfiguration : IEntityTypeConfiguration<Post>
{
    public void Configure(EntityTypeBuilder<Post> builder)
    {
        ...
        builder.Property(p => p.FragmentDescription).HasColumnName("fragment_description").HasColumnType("text");
        builder.Property(p => p.FragmentStartTime).HasColumnName("fragment_start_time");
        builder.Property(p => p.FragmentEndTime).HasColumnName("fragment_end_time");
        builder.Property(p => p.FragmentStorageKey).HasColumnName("fragment_storage_key").HasMaxLength(500);
        builder.Property(p => p.FragmentThumbnailKey).HasColumnName("fragment_thumbnail_key").HasMaxLength(500);
